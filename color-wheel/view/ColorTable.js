...
const createHeaderRow = () => {
  ...
  const cells = [
    ...
    RU.createCell("Components", "componentsHeaderCell", headerClass)
  ];
...
const createRow = color => {
  ...
  const cells = [
    ...
    RU.createCell(CU.toString(color), "hslCell", `${cellClass} pa1 tr`),
    RU.createCell(color.components, "componentsCell", `${cellClass} pa1 tc`)
  ];
